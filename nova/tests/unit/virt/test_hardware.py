        ...
        testdata = [
            ...
            },
            {
                ...
                "expect": objects.InstanceNUMATopology(cells=
                    [
                        objects.InstanceNUMACell(
                            id=0, cpuset=set([0, 1, 2, 3]), memory=1024,
                            virtual_pmems=[objects.VirtualPMEM(size=256,
            ...
            },
            {
                ...
                "expect": objects.InstanceNUMATopology(cells=[
                        objects.InstanceNUMACell(
                            id=0, cpuset=set([0, 1, 2, 3, 4, 5, 6, 7]),
                            memory=2048,
                            virtual_pmems=[objects.VirtualPMEM(size=512,
                                assigned_namespace=None)])
                    ]),
            },
            {
            ...
            },
            {
                "flavor": objects.Flavor(vcpus=8, memory_mb=2048, extra_specs={
                    ...
                    "hw:numa_cpus.2": "5,7",
                    "hw:numa_mem.2": "512",
                    "hw:numa_pmems.0.0": 128,
                    "hw:numa_pmems.0.1": 128,
                    "hw:numa_pmems.1.0": 128,
                    "hw:numa_pmems.2.0": 64,
                }),
                "image": {
                },
                "expect": objects.InstanceNUMATopology(cells=
        ...
        for testitem in testdata:
            ...
            if testitem["expect"] is None:
                ...
                for cell in topology.cells:
                    ...
                    if topology.cells[i].virtual_pmems is None:
                        self.assertIsNone(
                        ...
                        for j in range(
                                len(topology.cells[i].get('virtual_pmems',
                                                          []))):
                            self.assertEqual(
                                testitem[
                                    "expect"].cells[i].virtual_pmems[j].size,
                                topology.cells[i].virtual_pmems[j].size)
                            self.assertEqual(
                                testitem[
                                    "expect"].cells[
                                        i].virtual_pmems[j].assigned_namespace,
                                topology.cells[
                                    i].virtual_pmems[j].assigned_namespace)
