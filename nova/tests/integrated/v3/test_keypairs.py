...
class KeyPairsSampleJsonTest(api_sample_base.ApiSampleTestBaseV3):
    sample_dir = "keypairs"
    extension_name = 'keypairs'
    section_name = 'Keypairs'
    section_doc = ('Keypairs management support. Support create, import, '
                   'list, delete keypairs')
    ...
    def test_keypairs_post(self, public_key=None):
        ...
        response = self._doc_do_post(
            'keypairs', (), (), 'keypairs-post-req',
            {'keypair_name': key_name}, api_desc='Create keypair')
    ...
    def test_keypairs_import_key_post(self):
        ...
        response = self._doc_do_post(
            'keypairs', (), (), 'keypairs-import-post-req', subs,
            api_desc='Import keypair')
        subs = self._get_regexes()
        subs['keypair_name'] = '(%s)' % key_name
    ...
    def test_keypairs_get(self):
        ...
        response = self._doc_do_get(
            'keypairs', (), (), api_desc='List of keypairs for a user')
        subs = self._get_regexes()
        subs['keypair_name'] = '(%s)' % key_name
